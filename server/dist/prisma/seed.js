...
async function main() {
    ...
    // Create users
    const adminHash = await bcrypt_1.default.hash('demo1234', 10);
    const modHash = await bcrypt_1.default.hash('demo1234', 10);
    const memberHash = await bcrypt_1.default.hash('demo1234', 10);
